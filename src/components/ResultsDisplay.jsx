    ...
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden', background: '#03030a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 40, position: 'relative' }}>
          <div style={{ fontFamily: 'monospace', color: '#ffd700', fontSize: 64, letterSpacing: 8, marginBottom: 8, textShadow: '0 0 40px #ffd70088' }}>
            ◆ 2026 牛肉麵節 ◆
          </div>
          <div style={{ fontFamily: 'monospace', color: '#fff', fontSize: 32, letterSpacing: 10, textShadow: '0 0 20px #ffffff44' }}>
            即時投票結果
          </div>
        ...
        <div style={{ position: 'absolute', bottom: 8, right: 16, fontSize: 10, color: '#ffd700', fontFamily: 'monospace' }}>GAS v8</div>
